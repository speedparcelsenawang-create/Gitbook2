...
var require_lg_zoom = __commonJS({
  "node_modules/lg-zoom.js/dist/lg-zoom.js"(exports, module) {
    (function(f) {
      ...
      return (/* @__PURE__ */ function() {
        ...
        (function(global2, factory) {
          ...
          var getUseLeft = function getUseLeft2() {
            var useLeft = false;
          ...
          var Zoom = function Zoom2(element) {
            this.el = element;
          ...
          Zoom.prototype.init = function() {
            ...
            var scale = 1;
            var zoom = function zoom2(scaleVal) {
            ...
            var callScale = function callScale2() {
              if (scale > 1) {
            ...
            var actualSize = function actualSize2(event, image, index, fromIcon) {
            ...
            utils.on(_this.core.el, "onAferAppendSlide.lgtmzoom", function(event) {
              ...
              if (!_this.core.isTouch) {
                utils.on(image, "dblclick", function(event2) {
                  actualSize(event2, image, index);
                });
              }
              if (_this.core.isTouch) {
                utils.on(image, "touchstart", function(event2) {
                  if (!tapped) {
...
export default require_lg_zoom();
...
lg-zoom.js/dist/lg-zoom.js:
   ...
   *)
*/
//# sourceMappingURL=lg-zoom__js_dist_lg-zoom__js.js.map
